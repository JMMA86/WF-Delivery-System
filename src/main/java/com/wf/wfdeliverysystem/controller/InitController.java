...
public class InitController {
    ...
    public void onCheckDelivery(ActionEvent actionEvent) throws VertexNotAchievableException, VertexNotFoundException, LoopsNotAllowedException {
        resetMovements();
        ...
        if( !Launcher.getManager().checkPathBetweenHouses(selectedHQ, selectedHouse) ) {
            ArrayList<Pair<House, House>> edges = null;
            edges = Launcher.getManager().generateDeliveryTour(selectedHQ);
    ...
    public void onGenerateTour(ActionEvent actionEvent) throws VertexNotFoundException, VertexNotAchievableException, LoopsNotAllowedException {
        resetMovements();
        resetHouses();
        ArrayList<Pair<House, House>> edges = null;
        edges = Launcher.getManager().generateDeliveryTour(selectedHQ);
