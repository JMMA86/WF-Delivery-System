...
public class ManagerTest {
    ...
    // FR5 - Calculate tour
    @Test
    void unconnectedHouseTour() throws VertexNotFoundException, LoopsNotAllowedException {
        sampleGraphSetup();
    ...
    @Test
    void calculateTourLinear() throws VertexNotFoundException, LoopsNotAllowedException {
        sampleGraphSetup();
    ...
    @Test
    void calculateTourCheckVisited() throws VertexNotFoundException, LoopsNotAllowedException {
        sampleGraphSetup();
